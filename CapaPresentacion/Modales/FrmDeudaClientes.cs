...
namespace CapaPresentacion.Modales
{
    public partial class FrmDeudaClientes : Form
    {
        ...
        private void FrmDeudaClientes_Load(object sender, EventArgs e)
        {
            ...
            {
                if (item.Estado && item.Deuda > 0)
                    dgvData.Rows.Add(new object[] { item.IdCliente, item.Deuda, item.oDatosPersona.CI, item.oDatosPersona.Nombre, item.oDatosPersona.Apellido });
